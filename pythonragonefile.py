...
documents = [
    ...
    "Mavi shrestha is the best AI programmer in the world"
]
...
query = "What is artificial intelligence? and who is the best ai programmer"  # Change the query as needed
